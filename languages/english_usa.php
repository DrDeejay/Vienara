...
$txt['i_accept'] = 'After you have logged in, a session will be placed to keep you logged in. This session contains a hash of the administrator password. If you do not accept this, you are not able to login. This is needed in order to comply with the law of the EU which requires users to give permission before a cookie can be placed.';
$txt['cookie_okay'] = 'I accept that a cookie will be placed on my computer';
